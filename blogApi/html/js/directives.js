var dir=angular.module('directiveApp',[]);
dir.directive('jsLoading',function(){
...
dir.directive('comjsLoading',function(){
      return{
        restrict : "EA",
...
dir.directive('repeatDir',function($compile){
    return{
        restrict:'AE',
        replace:true,
...
dir.directive('blogFinded',function($compile){
 return{
        replace:true,
        link:function($scope,$elem,attrs){
