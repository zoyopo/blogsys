...
appService.service('dateFormatService',function(){
    var dt=new  Date();
...
appService.factory('requestFactory',function($http){
    var request = {
        req: {
...
appService.factory('requestLogicFactory',function(){
       var logic = {
...
appService.service('blog_finder',function(){
